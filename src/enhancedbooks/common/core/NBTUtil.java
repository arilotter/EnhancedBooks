...
public class NBTUtil {
    ...
    /**
     * Gets a String value of the given tag from the {@link NBTTagCompound} of the given
     ...
     * @return The value of the given tag as a String or an empty String if the NBT Tag
    ...
    /**
     * Sets the given String value for the given tag on the {@link NBTTagCompound} of the
     * given {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
    ...
    /**
     * Gets a Boolean value of the given tag from the {@link NBTTagCompound} of the given
     * {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag for which the value should be determined.
    ...
    /**
     * Sets the given boolean value for the given tag on the {@link NBTTagCompound} of the
     * given {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag which should be set.
    ...
    /**
     * Gets a Byte value of the given tag from the {@link NBTTagCompound} of the given
     * {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag for which the value should be determined.
     * @return The value of the given tag as a Byte or 0 if the NBT Tag
     *         Compound has no such key.
     */
    ...
    /**
     * Sets the given byte value for the given tag on the {@link NBTTagCompound} of the
     * given {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag which should be set.
    ...
    /**
     * Gets a Short value of the given tag from the {@link NBTTagCompound} of the given
     * {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag for which the value should be determined.
    ...
    /**
     * Sets the given short value for the given tag on the {@link NBTTagCompound} of the
     * given {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag which should be set.
    ...
    /**
     * Gets an Integer value of the given tag from the {@link NBTTagCompound} of the given
     * {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag for which the value should be determined.
    ...
    /**
     * Sets the given integer value for the given tag on the {@link NBTTagCompound} of the
     * given {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag which should be set.
    ...
    /**
     * Gets a Long value of the given tag from the {@link NBTTagCompound} of the given
     * {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag for which the value should be determined.
     * @return The value of the given tag as a Long or 0 if the NBT Tag
     *         Compound has no such key.
     */
    ...
    /**
     * Sets the given long value for the given tag on the {@link NBTTagCompound} of the
     * given {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag which should be set.
    ...
    /**
     * Gets a Float value of the given tag from the {@link NBTTagCompound} of the given
     * {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag for which the value should be determined.
    ...
    /**
     * Sets the given float value for the given tag on the {@link NBTTagCompound} of the
     * given {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag which should be set.
    ...
    /**
     * Gets a Double value of the given tag from the {@link NBTTagCompound} of the given
     * {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag for which the value should be determined.
    ...
    /**
     * Sets the given double value for the given tag on the {@link NBTTagCompound} of the
     * given {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag which should be set.
    ...
    /**
     * Gets a {@link NBTTagCompound} value of the given tag from the {@link NBTTagCompound} of the given
     * {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag for which the value should be determined.
    ...
    public static NBTTagCompound getCompoundTag(ItemStack itemStack, String tagName) {
        ...
        if (!itemStack.stackTagCompound.hasKey(tagName)) {
            itemStack.stackTagCompound.setCompoundTag(tagName, new NBTTagCompound());
        }
    ...
    /**
     * Sets the given {@link NBTTagCompound} value for the given tag on the {@link NBTTagCompound} of the
     * given {@link ItemStack}. If the {@link NBTTagCompound} is null it will be initialized.
     *
     * @param itemStack The {@link ItemStack} which holds the {@link NBTTagCompound}.
     * @param tagName   The name of the tag which should be set.
    ...
    public static void setCompoundTag(ItemStack itemStack, String tagName, NBTTagCompound tagValue) {
        initNBTTagCompound(itemStack);
        itemStack.stackTagCompound.setCompoundTag(tagName, tagValue);
    }
}